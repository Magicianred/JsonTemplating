...
namespace JsonTemplating
{
    public class JsonTemplateVisitor: JsonVisitor
    {
        ...
        protected override JToken VisitValue(JValue value)
        {
            if (value.Type == JTokenType.String)
            {
                ...
                if (s.StartsWith("$"))
                {
                    ...
                    var newValue = GetValue(data, path);
        ...
        private static object GetValue(object data, string path)
        {
            ...
            foreach (var part in parts)
            {
                ...
                data = data.GetType().GetProperty(part).GetValue(data, null);
            }
